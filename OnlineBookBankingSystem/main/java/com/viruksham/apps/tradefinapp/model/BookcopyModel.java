...
import com.viruksham.apps.tradefinapp.dao.BookcopyDao;
...
public class BookcopyModel {
	...
	//private static Map<String, Object> mockUserData = initMockBookcopyData();

	public BookcopyModel() throws ClassNotFoundException, SQLException, FileNotFoundException {
	...
	public Object getUserTypeList() {
		...
		return BookcopyDao.getUserTypeList();
	}

	public Object getUserTypeGet(String GetID) {
System.out.println("entered into Bookcopy model");
		return BookcopyDao.getUserTypeGet(GetID);
	}

	public Object getUserTypeDelete(String delete) {
		return BookcopyDao.getUserTypeDelete(delete);
	}
	...
	System.out.println("entered into add customer model");
		...
		BookcopyData BookcopyData = new BookcopyData(data);
		BookcopyData.createBookcopy();
			@SuppressWarnings("unchecked")
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)BookcopyDao.insertdata(BookcopyData));
	...
	System.out.println("entered into update customer model");
		...
		System.out.println(BookcopyData+"hi");		
			@SuppressWarnings("unchecked")
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)BookcopyDao.editdata(BookcopyData));
			retVal = new HashMap<String, Integer>();
			// Retrieve the uuid
			retVal.put("id", Integer.valueOf(execResult.get(GENERATED_KEY)));	
		return retVal;
