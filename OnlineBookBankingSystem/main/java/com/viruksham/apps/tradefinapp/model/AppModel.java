...
import com.viruksham.apps.tradefinapp.dao.AppDao;
...
public class AppModel {
	...
	//private static Map<String, Object> mockUserData = initMockAppData();

	public AppModel() throws ClassNotFoundException, SQLException, FileNotFoundException {
		AppDao = new AppDao();
	}
	...
	public Object getUserTypeList() {
		...
		return AppDao.getUserTypeList();
	}

	public Object getUserTypeGet(String GetID) {
System.out.println("entered into App model");
		return AppDao.getUserTypeGet(GetID);
	}

	public Object getUserTypeDelete(String delete) {
		return AppDao.getUserTypeDelete(delete);
	}
	...
	System.out.println("entered into add customer model");
		...
		AppData.createApp();
			...
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)AppDao.insertdata(AppData));
	...
	System.out.println("entered into update customer model");
		...
		//System.out.println(AppData+"hi");		
			@SuppressWarnings("unchecked")
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)AppDao.editdata(AppData));
			retVal = new HashMap<String, Integer>();
			// Retrieve the uuid
			retVal.put("id", Integer.valueOf(execResult.get(GENERATED_KEY)));	
		return retVal;
