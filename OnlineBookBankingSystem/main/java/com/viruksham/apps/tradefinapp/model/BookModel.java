...
import com.viruksham.apps.tradefinapp.dao.BookDao;
...
public class BookModel {
	...
	//private static Map<String, Object> mockUserData = initMockBookData();

	public BookModel() throws ClassNotFoundException, SQLException, FileNotFoundException {
		BookDao = new BookDao();
	}
	...
	public Object getUserTypeList() {
		...
		return BookDao.getUserTypeList();
	}

	public Object getUserTypeGet(String GetID) {
System.out.println("entered into Book model");
		return BookDao.getUserTypeGet(GetID);
	}

	public Object getUserTypeDelete(String delete) {
		return BookDao.getUserTypeDelete(delete);
	}
	...
	System.out.println("entered into add customer model");
		...
		BookData BookData = new BookData(data);
		BookData.createBook();
			@SuppressWarnings("unchecked")
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)BookDao.insertdata(BookData));
			retVal = new HashMap<String, Integer>();
			// Retrieve the uuid
			retVal.put("bookid", Integer.valueOf(execResult.get(GENERATED_KEY)));	
		return retVal;
	}
	...
	System.out.println("entered into update customer model");
		...
		//System.out.println(BookData+"hi&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&77");		
			@SuppressWarnings("unchecked")
			Map<String, String> execResult =
					(Map<String, String>) ((List<Object>)BookDao.editdata(BookData));
			retVal = new HashMap<String, Integer>();
			// Retrieve the uuid
			retVal.put("bookid", Integer.valueOf(execResult.get(GENERATED_KEY)));	
		return retVal;
